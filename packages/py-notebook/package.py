...
class PyNotebook(PythonPackage):
    ...
    pypi = "notebook/notebook-6.5.6.tar.gz"

    version(
        "6.5.7",
        sha256="617209568bd47261e2def27a140e97d49070602eea0d226a696f42a7f16c9a4e",
    )
    version(
        "6.5.4",
    ...
    depends_on(
        "py-jupyter-core@4.4.0:", when="@5.7.0:6.0.1", type=("build", "run")
    )
    depends_on("py-jupyter-core", type=("build", "run"))
    depends_on("py-jupyter-client@5.3.4:", when="@6.0.2:", type=("build", "run"))
    depends_on(
        "py-jupyter-client@5.3.1:", when="@6.0.0:6.0.1", type=("build", "run")
    )
